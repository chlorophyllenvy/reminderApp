...
.booking-widget {
  width: 360px;
  padding: 120px 18px 60px 32px;
  font-size: 14px !important;
  color: #222222 !important;
  background: url("../images/booking-widget--jetblue.png") no-repeat;
}
...
.page--bills-bar-burger-downtown {
  background-image: url("../images/backgrounds/menus-and-food.jpg");
}

.page--special-events {
  background-image: url("../images/backgrounds/special-events.jpg");
}
...
.page--book-here {
  background-image: url("../images/backgrounds/book-here.jpg");
}
